				...
				<div class="row post_meta">
					...
					<div class="col-12">
						<div class="share-block">
							<a class="a2a_button_facebook" href="https://www.facebook.com/sharer.php?u=<?php the_permalink();?>&t=<?php the_title(); ?>" title="Facebook" rel="nofollow noopener" target="_blank">
