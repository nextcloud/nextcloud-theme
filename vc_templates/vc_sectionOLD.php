...
if ($has_video_bg) {
	$output .= '<video preload="metadata" loop="" autoplay="" muted="" playsinline="" poster="" style="visibility: visible;" width="1280" height="720"><source src="'.$video_bg_url.'" type="video/mp4"></video>';
}
