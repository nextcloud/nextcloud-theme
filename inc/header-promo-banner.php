					...
					if($image) {
                        ...
                        <div class="cloudcomputing-logo">
                            <a tabindex="-1" href="<?php if (get_field('header_promo_button_link', 'option')) {
                            	echo get_field('header_promo_button_link', 'option');
                            } ?>" title="<?php
                        ...
                        <div class="awards-text">
                            <a tabindex="-1" href="<?php if (get_field('header_promo_button_link', 'option')) {
                            	echo get_field('header_promo_button_link', 'option');
                            } ?>" title="<?php if (get_field('header_promo_text', 'option')) {
                            	echo strip_tags(get_field('header_promo_text', 'option'));
                            } ?>" target="_blank">
                                <?php if (get_field('header_promo_text', 'option')) {
                                	echo get_field('header_promo_text', 'option');
                                } ?>
                            </a>
                        </div>
                                ...
                                <div class="awards-text">
                                    <a tabindex="-1" href="<?php echo get_permalink(); ?>" title="<?php echo get_the_title(); ?>" target="_blank">
                                        <?php if (get_field('top_banner_text')) {
                                        	echo get_field('top_banner_text');
                                        } ?>
                                    </a>
                                </div>
